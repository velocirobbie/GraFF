...
PairStyle(hbond/graphene,PairHbondGraphene)

#else

#ifndef LMP_PAIR_HBOND_GRAPHENE_H
#define LMP_PAIR_HBOND_GRAPHENE_H

#include "pair.h"

namespace LAMMPS_NS {

class PairHbondGraphene : public Pair {
 public:
  PairHbondGraphene(class LAMMPS *);
  virtual ~PairHbondGraphene();
